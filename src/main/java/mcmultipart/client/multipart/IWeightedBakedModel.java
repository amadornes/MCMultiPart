...
/**
 * Interface that represents a model whose sides have different sorting priorities. Lower weights get added after higher weights, rendering
 * on top of them and vice versa.
 */
