...
/**
 * Interface that represents an {@link IMicroblock} material. For advanced per-microblock functionality, you'll want to implement
 * {@link IDelegatedMicroMaterial}.<br/>
 * For a default implementation of most of these methods and some helpers, you can use {@link BlockMicroMaterial} directly.
 *
 * @see IMicroblock
...
public interface IMicroMaterial {
    ...
    /**
     * Interface that represents an {@link IMicroblock} material with method delegation. If you don't need this kind of advanced
     * functionality, implement {@link IMicroMaterial} instead.
     *
     * @see IMicroblock
     * @see IMicroMaterial
    ...
    public static interface IDelegatedMicroMaterial extends IMicroMaterial {
        ...
        /**
         * Gets a delegate for the specified microblock. This delegate allows you to add special interaction with microblocks made out of
         * this micro material to handle things like clicking, redstone I/O, etc.
         *
         * @see MicroblockDelegate
         */
