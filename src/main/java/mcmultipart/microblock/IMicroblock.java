 ...
 * Do not implement this if you don't know what you're doing, you're probably
 * looking for {@link IMultipart} or {@link Multipart}.
 */
public interface IMicroblock extends ISlottedPart
{
    ...
    /**
     * Gets the slot this microblock occupies, or none if it doesn't occupy a
     * slot.
     */
