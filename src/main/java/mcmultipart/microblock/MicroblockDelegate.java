...
/**
 * Represents an object to which microblock events are delegated. This allows for custom interaction and data storage inside the microblock.
 */
public class MicroblockDelegate {
    ...
    /**
     * Gets the strength of a player against this microblock. Not to be confused with {@link Multipart#getHardness(PartMOP)}. This also
     * takes potion effects and tools into account.
     */
    ...
    /**
     * Writes this microblock's data to a packet buffer for it to be sent to the client. This is called when the client gets close enough to
     * the container that it gets synced and also and when {@link MicroblockDelegate#sendUpdatePacket()} is called.
     */
