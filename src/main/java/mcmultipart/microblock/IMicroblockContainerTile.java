...
/**
 * Interface implemented by TileEntities which want to act as microblock
 * containers.
 */
public interface IMicroblockContainerTile extends IWorldLocation
{
    ...
    /**
     * Checks whether or not a specific microblock can be added to this tile.
     * This is checked internally in {@link MicroblockContainer}.
     */
