...
public class MultipartRegistry
{
    ...
    /**
     * Links a set of parts to an {@link IAdvancedPartFactory} that can produce
     * them.
     */
    ...
    /**
     * Registers a part along with an identifier. A default part factory is
     ...
     * Only for internal use. This will not return the type of custom
     * multiparts!
     */
    ...
    /**
     * Gets the {@link BlockStateContainer} that represents a specific part
     * type.
     */
    ...
    /**
     * Converts the block at the specified location into a collection of
     * multiparts. Doesn't actually replace the block.
     */
    ...
    /**
     * Converts a multipart container back into a block. Actually replaces the
     * block.
     */
