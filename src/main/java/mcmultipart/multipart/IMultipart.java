...
/**
 * Interface that represents a multipart. This has all the methods required for
 * a multipart to work properly.<br/>
 * For a simple, default implementation of most of these methods and some
 * helpers, you can extend {@link Multipart} directly.
 */
public interface IMultipart
{
    ...
    /**
     * Returns the identifier for this type of part. This will be passed into
     * the {@link IPartFactory} or {@link IAdvancedPartFactory} to create the
     * part in the client, or when loaded from NBT.
     */
    ...
    /**
     * Ray traces through the part's collision from start vector to end vector
    ...
    /**
     * Adds this part's collision boxes to the list for the specified entity if
     * they intersect the mask.
     *
     * @param mask
     *            A mask that represents the bounds of the block. All boxes
     *            added to the list must intersect this mask.
     * @param list
    ...
    /**
     * Performs an occlusion test against the specified part. Returning true
     * means that they aren't occluding each other, returning false means
     * otherwise.
     */
    ...
    /**
     * Gets the block that will be obtained by creative players when they
     * middle-click this part.
     */
    ...
    /**
     * Gets the strength of a player against this part. Not to be confused with
     * {@link Multipart#getHardness(PartMOP)}. This also takes potion effects
    ...
    /**
     * Called when a player right-clicks this part. Return true to play the
    ...
    /**
     * Writes this part's data to a packet buffer for it to be sent to the
     * client. This is called when the client gets close enough to the container
     * that it gets synced and also and when
     * {@link IMultipart#sendUpdatePacket()} is called.
     */
    ...
    /**
     * Checks whether or not this part can be rendered in the specified world
     * layer.
     */
    public boolean canRenderInLayer(BlockRenderLayer layer);
    
    /**
     * Gets the extended state of this part. <b>ONLY USED FOR RENDERING, THIS IS
     * NOT WHERE YOU STORE DATA.</b>
     */
    ...
    /**
     * Gets the bounding box used to render this part dynamically. By default,
     * all multipart containers have a bounding box that goes from (0, 0, 0) to
     * (1, 1, 1) so that breaking animations can be rendered, but this can be
     * expanded here.
     */
