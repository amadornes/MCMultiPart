...
/**
 * A general use multipart helper with methods for part addition and placement
 * checking.
 */
public class MultipartHelper
{
    ...
    /**
     * Checks whether or not the specified part can be replaced by another part
     * to the world.
     */
    ...
    /**
     * Checks whether or not a part of the specified type can be replaced by
     * another part to the world.
     */
    ...
    /**
     * Adds a part at the specified location in the world, with the provided
     * UUID.
     */
    ...
    /**
     * Gets the part container at the specified position. Doesn't handle block
     * conversion.
     */
    ...
    /**
     * Gets the part container at the specified position. Handles block
     * conversion. If doConvert is true, the block is converted into a multipart
     * container. If not, it returns a dummy container with all the converted
     * parts.
     */
