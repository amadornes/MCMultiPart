...
/**
 * Implement this interface to add redstone support to your {@link IMultipart}.
 * <br/>
 * If your part also implements {@link ISlottedPart}, you may want to implement
 * {@link ISlottedRedstonePart} instead.
 */
public interface IRedstonePart extends IMultipart
{
    ...
    /**
     * Gets the strong redstone signal output by this part on the specified
     * side.
     */
    public int getStrongSignal(EnumFacing side);
    
    /**
     * Implement this interface to add redstone support to your
     * {@link ISlottedPart}.
     */
