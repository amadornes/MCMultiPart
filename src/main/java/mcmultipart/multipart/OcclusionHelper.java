...
/**
 * A general use occlusion helper, with methods to check part-part occlusion,
 * part-AABB occlusion, as well as slot occlusion.
 */
public class OcclusionHelper
{
    ...
    /**
     * Performs an occlusion test between a part and the specified collection of
     * parts.
     *
     * @param part
     *            The part to test.
    ...
    /**
     * Performs an occlusion test between a part and the specified multipart
     * container.
     *
     * @param part
     *            The part to test.
    ...
    /**
     * Performs an occlusion test between a slot and the specificed collection
     * of parts.
     *
     * @param slot
     *            The slot to test.
    ...
    /**
     * Performs an occlusion test between a slot and the specificed multipart
     * container.
     *
     * @param slot
     *            The slot to test.
    ...
    /**
     * Creates a {@link Predicate} that returns true for the specified parts and
     * false for any others.
     *
     * @param parts
     *            The parts to be ignored.
     * @return A {@link Predicate} that only returns true for the specified
     *         parts.
     */
    ...
    /**
     * Returns a {@link NormallyOccludingPart} that occludes the specified
     * boxes. <b>The output of this method is not meant to be cached</b> , since
     * every time the method is called the boxes that the object occupies will
     * change. If you need to cache the result, create your own instance of
     * {@link NormallyOccludingPart} by using the constructor.
     *
     * @param boxes
     *            The boxes to be occluded.
     * @return An instance of {@link NormallyOccludingPart} that occludes the
     *         specified boxes.
     */
    ...
    /**
     * <b>Deprecated. Use
     * {@link OcclusionHelper#occlusionTest(IMultipart, Predicate, Iterable)}
     * instead.</b>
     */
    @Deprecated
    ...
    /**
     * <b>Deprecated. Use
     * {@link OcclusionHelper#occlusionTest(IMultipart, IMultipart)}
     * instead.</b>
     */
    @Deprecated
    ...
    /**
     * <b>Deprecated. Use
     * {@link OcclusionHelper#occlusionTest(IMultipart, Iterable)} instead.</b>
     */
    @Deprecated
    ...
    /**
     * <b>Deprecated. Use
     * {@link OcclusionHelper#occlusionTest(IMultipart, Predicate, IMultipart...)}
     * instead.</b>
     */
    @Deprecated
    ...
    /**
     * <b>Deprecated. Use
     * {@link OcclusionHelper#slotOcclusionTest(PartSlot, Predicate, IMultipartContainer)}
     * instead.</b>
     */
    @Deprecated
    ...
    /**
     * <b>Deprecated. Use
     * {@link OcclusionHelper#slotOcclusionTest(PartSlot, Predicate, Iterable)}
     * instead.</b>
     */
    @Deprecated
    ...
    /**
     * An {@link INormallyOccludingPart} that occludes a certain set of
     * {@link AxisAlignedBB}s.
     */
