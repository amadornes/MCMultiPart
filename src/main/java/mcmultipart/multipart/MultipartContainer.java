...
/**
 * Helper class that contains all the logic required for an
 * {@link IMultipartContainer} to work, as well as methods that are forwarded to
 * each of the parts.<br/>
 * You can implement {@link IMultipartContainer} in your {@link TileEntity} and
 * forward the calls to an instance of this class for default multipart
 * container logic.
 */
public class MultipartContainer implements IMultipartContainer
{
    ...
    public void removePart(IMultipart part, boolean notifyPart, boolean notifyNeighbors, boolean postEvent)
    {
        ...
        // Yes, it's a bit of a dirty solution, but it's the best I could come
        // up with. The part must not be there in the if statement :P
