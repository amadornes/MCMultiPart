...
/**
 * Implement this interface to allow conversion of normal blocks into
 * multiparts.
 */
public interface IPartConverter
{
    ...
    /**
     * Converts a block into a collection of multiparts. Simulated determines
     * whether we're getting the parts to perform checks or to actually convert
     * the block.
     */
