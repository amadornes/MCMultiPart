...
public enum PartSlot implements IStringSerializable
{
    ...
    DOWN(EnumFacing.DOWN), UP(EnumFacing.UP), NORTH(EnumFacing.NORTH), SOUTH(EnumFacing.SOUTH), WEST(EnumFacing.WEST), EAST(EnumFacing.EAST), CENTER(null), EDGE_XNN(EnumFacing.DOWN,
            EnumFacing.NORTH), EDGE_XNP(EnumFacing.DOWN, EnumFacing.SOUTH), EDGE_XPN(EnumFacing.UP, EnumFacing.NORTH), EDGE_XPP(EnumFacing.UP, EnumFacing.SOUTH), EDGE_NYN(EnumFacing.WEST,
                    EnumFacing.NORTH), EDGE_NYP(EnumFacing.WEST, EnumFacing.SOUTH), EDGE_PYN(EnumFacing.EAST, EnumFacing.NORTH), EDGE_PYP(EnumFacing.EAST, EnumFacing.SOUTH), EDGE_NNZ(EnumFacing.WEST,
                            EnumFacing.DOWN), EDGE_NPZ(EnumFacing.WEST, EnumFacing.UP), EDGE_PNZ(EnumFacing.EAST, EnumFacing.DOWN), EDGE_PPZ(EnumFacing.EAST, EnumFacing.UP), CORNER_NNN(
                                    EnumFacing.WEST, EnumFacing.DOWN, EnumFacing.NORTH), CORNER_NNP(EnumFacing.WEST, EnumFacing.DOWN, EnumFacing.SOUTH), CORNER_NPN(EnumFacing.WEST, EnumFacing.UP,
                                            EnumFacing.NORTH), CORNER_NPP(EnumFacing.WEST, EnumFacing.UP, EnumFacing.SOUTH), CORNER_PNN(EnumFacing.EAST, EnumFacing.DOWN, EnumFacing.NORTH), CORNER_PNP(
                                                    EnumFacing.EAST, EnumFacing.DOWN,
                                                    EnumFacing.SOUTH), CORNER_PPN(EnumFacing.EAST, EnumFacing.UP, EnumFacing.NORTH), CORNER_PPP(EnumFacing.EAST, EnumFacing.UP, EnumFacing.SOUTH);
