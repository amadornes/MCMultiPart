 ...
 * Includes {@link AxisAlignedBB} raytracing, part hardness, materials and tool
 * effectivity, as well as helper methods to notify various kinds of updates to
 * the world.<br/>
 * {@link IMultipart#getType()} is implemented by default and it returns the
 * type with which this class was registered in {@link MultipartRegistry},
 * though custom types can be used if your part is created by a custom
...
public abstract class Multipart implements IMultipart, ICapabilitySerializable<NBTTagCompound>
{
    ...
    /**
     * Gets the hardness of this part. Similar to
     * {@link Block#getBlockHardness(World, BlockPos)}, not to be confused with
    ...
    /**
     * Checks if the specified tool is strong enough to harvest this part at
     * full speed.
     */
    ...
    /**
     * Similar to {@link IMultipart#sendUpdatePacket()}, but also allows the
     * user to specify if the chunk should be re-rendered on arrival.
     */
